...
class _$ThumbnailsSerializer implements StructuredSerializer<Thumbnails> {
  ...
  Iterable<Object> serialize(Serializers serializers, Thumbnails object,
    ...
    final result = <Object>[
      'default',
      serializers.serialize(object.defaultThumb,
  ...
  Thumbnails deserialize(Serializers serializers, Iterable<Object> serialized,
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'default':
          result.defaultThumb.replace(serializers.deserialize(value,
...
class _$Thumbnails extends Thumbnails {
  ...
  _$Thumbnails._({this.defaultThumb, this.medium, this.high}) : super._() {
    if (defaultThumb == null) {
      throw new BuiltValueNullFieldError('Thumbnails', 'defaultThumb');
    }
    if (medium == null) {
  ...
  bool operator ==(Object other) {
    ...
    return other is Thumbnails &&
        defaultThumb == other.defaultThumb &&
        medium == other.medium &&
        high == other.high;
  }
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc(0, defaultThumb.hashCode), medium.hashCode), high.hashCode));
  }

  @override
  String toString() {
    return (newBuiltValueToStringHelper('Thumbnails')
          ..add('defaultThumb', defaultThumb)
          ..add('medium', medium)
          ..add('high', high))
        .toString();
  }
...
class ThumbnailsBuilder implements Builder<Thumbnails, ThumbnailsBuilder> {
  ...
  ThumbnailBuilder _defaultThumb;
  ThumbnailBuilder get defaultThumb =>
      _$this._defaultThumb ??= new ThumbnailBuilder();
  set defaultThumb(ThumbnailBuilder defaultThumb) =>
      _$this._defaultThumb = defaultThumb;
  ...
  ThumbnailsBuilder get _$this {
    if (_$v != null) {
      _defaultThumb = _$v.defaultThumb?.toBuilder();
  ...
  _$Thumbnails build() {
    ...
    try {
      _$result = _$v ??
          new _$Thumbnails._(
              defaultThumb: defaultThumb.build(),
              medium: medium.build(),
              high: high.build());
    } catch (_) {
      String _$failedField;
      try {
        _$failedField = 'defaultThumb';
        defaultThumb.build();
