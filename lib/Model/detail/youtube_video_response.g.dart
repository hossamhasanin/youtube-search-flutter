    ...
    final result = <Object>[
      ...
      serializers.serialize(object.items,
          specifiedType: const FullType(
              BuiltList, const [const FullType(YoutubeVideoDetail)])),
    ];
...
class _$YoutubeVideoResponse extends YoutubeVideoResponse {
  @override
  final BuiltList<YoutubeVideoDetail> items;
...
class YoutubeVideoResponseBuilder
  ...
  ListBuilder<YoutubeVideoDetail> _items;
  ListBuilder<YoutubeVideoDetail> get items =>
      _$this._items ??= new ListBuilder<YoutubeVideoDetail>();
  set items(ListBuilder<YoutubeVideoDetail> items) => _$this._items = items;
